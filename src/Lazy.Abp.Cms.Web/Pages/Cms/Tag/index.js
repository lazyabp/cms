$(function () {
    ...
    var createModal = new abp.ModalManager(abp.appPath + 'Cms/Tag/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Cms/Tag/EditModal');
                ...
                rowAction: {
                    items:
                        [
                            {
                                text: l('Edit'),
                                visible: abp.auth.isGranted('Cms.Tag.Update'),
                            ...
                            {
                                text: l('Delete'),
                                visible: abp.auth.isGranted('Cms.Tag.Delete'),
