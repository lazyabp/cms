$(function () {
    ...
    var createModal = new abp.ModalManager(abp.appPath + 'Cms/Article/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Cms/Article/EditModal');
                ...
                rowAction: {
                    items:
                        [
                            {
                                text: l('Edit'),
                                visible: abp.auth.isGranted('Cms.Article.Update'),
                            ...
                            {
                                text: l('Delete'),
                                visible: abp.auth.isGranted('Cms.Article.Delete'),
