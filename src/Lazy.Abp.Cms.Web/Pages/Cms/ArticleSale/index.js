$(function () {
    ...
    var createModal = new abp.ModalManager(abp.appPath + 'Cms/ArticleSale/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Cms/ArticleSale/EditModal');
                ...
                rowAction: {
                    items:
                        [
                            {
                                text: l('Edit'),
                                visible: abp.auth.isGranted('Cms.ArticleSale.Update'),
                            ...
                            {
                                text: l('Delete'),
                                visible: abp.auth.isGranted('Cms.ArticleSale.Delete'),
