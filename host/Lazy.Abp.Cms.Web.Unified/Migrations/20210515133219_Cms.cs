    ...
    public partial class Cms : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmsArticleComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CmsArticleComments_CmsArticles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "CmsArticles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CmsArticleComments_ArticleId",
                table: "CmsArticleComments",
                column: "ArticleId");
